...
date: 2021-02-11T00:00:00-19:00
topics: []
...
#### Appium client
This contains the automation code (scripted). This code is written in a specific programming language like Java, Python, Ruby, or Perl. The script contains the configuration details of the application and the mobile device. The scripted code and the configuration details are used for running the applications' test cases.
