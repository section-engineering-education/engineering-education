...
- Understanding how to [Build Python Packages](https://www.section.io/engineering-education/building-a-python-package-and-publishing-on-pypi/)
...
To build our basic python package, we need two components, namely a `[setup.py](http://setup.py)` file and an `src` folder containing our package logic. Let's start with the `src` folder: it should contain three files, namely `__init__.py`, `[logic.py](http://logic.py)` and `main.py`. 
...
![actions.jpg](/engineering-education/
setting-up-cicd-for-python-packages-using-github-actions/actions.jpg)
