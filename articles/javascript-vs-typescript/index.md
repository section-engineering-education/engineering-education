...
On the other hand, [Anders Hejlsberg](https://en.wikipedia.org/wiki/Anders_Hejlsberg) developed [Typescript](https://www.npmjs.com/package/typescript), an open-source programing language. The Typescript was released to the public in [October 2012](https://en.wikipedia.org/wiki/TypeScript#History) at version 0.8 and version 0.9 in 2013. Microsoft Corporation added support to Typescript and launched Typescript version 1.0 in [July 2014](https://en.wikipedia.org/wiki/TypeScript#History).
