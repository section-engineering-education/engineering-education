In the first article of our software testing series, we talked about unit testing, how to run unit tests, the benefits, limitations. 
...
After that, we move to our thirld testing condition.
