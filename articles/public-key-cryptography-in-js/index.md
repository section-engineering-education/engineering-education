...
1. We compose ciphertext using `nacl.box()` passing the following parameters:
...
1. We compute the ciphertext using `nacl.box.after()` passing the following parameters:
