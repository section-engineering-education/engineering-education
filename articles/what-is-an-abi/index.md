...
<!--
1. Pass data to the caller
2. Transfer control to callee
3. Save the state of the caller
4. Run callee code
5. Set up the return value
6. Restore saved state of the caller
7. Transfer control back to the caller
...
![alt text](image1.png "Call stack")
