...
Winston allows you to implement [multiple logging channels](https://github.com/winstonjs/winston#working-with-multiple-loggers-in-winston), i.e., a log can be recorded to a file, console, or database.

The Logger configuration below log to a console and a file. We will add a transport array to the log configuration object. Later in this guide, we will show you how to log and record the log instances to a database.
