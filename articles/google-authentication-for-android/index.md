...
In this guide, you will integrate Google Authentication in an android application. 
...
This shows how important it is to authenticate users.
User Authentication is done in various ways.
Third-party authentication and filling forms are the most popular.
In 2019, one of the top ten User Experience (UX) trends were using third-party authentication options like Google, Facebook, Twitter, GitHub, etc.
This was due to the minimized effort and time required to authenticate a user.
...
![Open Android Studio](articles/google-authentication-for-android/name.png)

* Select *Empty Activity* and click on next.

![Select on Empty Activity](articles/google-authentication-for-android/name.png)

* We will name the project **GoogleSignUp**. Click on *Finish* and wait for the project to build.

![Empty Activity](/home/briana/Documents/EngineeringEd/newproject.png)
...
![Layout Resource File](articles/google-authentication-for-android/xml.png)
...
### Step 4 – Lets Code.
* Add the following dependencies to your **app** (build.gradle) and sync the project;
...
* Next, create a **handleSignInResult** method which will give out instructions on actions to be done if the process is successful . For instance, we would like to notify a user whether they have signed up or not, and if successful they should be able to access the next activity.
...
![GoogleSignUp](articles/google-authentication-for-android/finalthree.jpg)

Access the Source code [here](https://github.com/BrianaNzivu/googlesignup/blob/master/app/src/main/java/com/example/googlesignup/MainActivity.java).