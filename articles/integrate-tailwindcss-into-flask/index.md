...
TailwindCss is a utility-first CSS framework used to build frontend applications. TailwindCss differs from other CSS frameworks as it gives the user total control over their design.
...
This will install Flask neatly for us on our computer, if you already have it installed you can skip this step. You can also choose to install it in a virtual environment if you prefer.
...
Now in app.py we'll add the following code snippet to create a server.
