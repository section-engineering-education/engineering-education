...
In this tutorial, we will be learning how to install Metasploit Framework on your machine and also run some major commands. But before running any command on Metasploit, one should first scan their targets' network for vulnerabilities and gather the necessary information to perform an exploit. To learn how to scan your targets, go through the [Introduction to Nmap](https://www.section.io/engineering-education/nmap-network-scanner) tutorial linked.
 ...
 For your case, it is recommended that you use Metasploitable 2 as a  target to exploit.
 
 [Metasploitable 2](https://docs.rapid7.com/metasploit/metasploitable-2) is an intentionally vulnerable device that provides a secure environment to learn penetration testing.
...
msf5 > show targets
```
password when prompted:password when prompted:
...
### Further reading
For your further learning, go through the five stages of hacking by reading through the tutorials linked below:

**Stages of hacking**

 1. Reconnaissance - [Nmap](https://www.section.io/engineering-education/nmap-network-scanner)
 1. Scanning and Enumeration - [Nikto](https://tools.kali.org/information-gathering/nikto)
 1. Gaining access [John the Ripper](https://www.varonis.com/blog/john-the-ripper/)
 1. Maintaining access - Use of malwares, backdoors, trojan horse, etc
 1. [Covering tracks](https://blog.eccouncil.org/4-ways-that-ethical-hackers-cover-their-tracks/) - Using ICMP Tunnels, Clearing event logs, etc.
