...
If you are building an application targeting an Indian audience that requires a payment gateway, Razorpay is the most popular choice.
...
Create a new file called `config.js` and add your API key to it like:
