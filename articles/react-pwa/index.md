...
First, we now need to create a new React application using the boilerplate code generated by the `create-react-app` command-line utility. On your terminal, execute the following command:
...
You can install the `uuid` package using this command in your terminal:
