...
A scope is used to control the lifecycle of a coroutine. Here, we have used the `GlobalScope` which means that the coroutine will be limited to the lifecycle of the application.
