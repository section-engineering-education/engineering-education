...
A token is a dynamic key generated by using App ID, App Certificate, User ID, Channel name, Token expiration timestamp, and other information. Tt's recommended to use a token for authentication as it's more secure than App ID authentication.
...
You can refer the documentation for Agora's authentication [here](https://docs.agora.io/en/Agora%20Platform/token?platform=Android).
