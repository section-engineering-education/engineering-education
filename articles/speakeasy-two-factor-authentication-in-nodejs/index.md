...
status: publish
published: true
url: /engineering-education/speakeasy-two-factor-authentication-in-nodejs/
...
author: mia-roberts
date: 2021-05-02T00:00:00-18:30
topics: [Node.js]
...
images:
  ...
  - url: /engineering-education/speakeasy-two-factor-authentication-in-nodejs/hero.jpg
    alt: 2FA hero image
---
Two-factor authentication is a security measure implemented in an application to increase security by providing two separate pieces evidences of authorization to the system. Two-factor authentication (2FA) works beyond username/email and password authentication.
<!--more-->
