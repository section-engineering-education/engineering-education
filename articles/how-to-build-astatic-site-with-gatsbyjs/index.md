...
Go to the [official Node.js website](https://nodejs.org/en/) to download the Node.js version for your operating system. Installing Node.js comes together with a node package manager installed.
...
npm –version
```
This also is to verify you have the node package manager installed and to see your current version. 
