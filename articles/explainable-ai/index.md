...
On the other hand, complex methods are designed without explainability in mind. These methods often provide greater performance than simple AI methods. They are not designed to be interpretable. The advancements of deep learning, coupled with an increase in computational power (accessible for the algorithms), makes these complex methods even more unpredictable. Explanations become foggier. A trade-off between explainability and performance emerges.
