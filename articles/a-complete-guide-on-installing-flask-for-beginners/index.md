...
Flask could be related to the analogy of a compact home library, while Django could be attributed to a state library. The point here is that, when you intend to build apps that have minimal functionality, Flask is one of the best choices.
