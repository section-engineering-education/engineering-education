...
We will be discussing two methods. For multi-task learning using Deep Learning, either [hard or soft parameter sharing](https://avivnavon.github.io/blog/parameter-sharing-in-deep-learning/) is used for hidden layers.
