Adding animations can take you to the next level by making your website seem livelier and more attractive to your users. The downfall of adding animations to a website using JavaScript, as this is the widely used language in adding dynamicity to a website, is animations lead to a website loading slower, especially when the developer fails to select an optimized library. However, there is a turnaround to such a problem, and that is using CSS and HTML only.

### Introduction
This article will show you how to add animations using CSS and HTML only. 
