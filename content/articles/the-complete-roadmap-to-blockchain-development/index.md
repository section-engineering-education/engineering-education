...
In addition, learning a framework would enable you to build a dynamic user interface quite quickly though that's optional if you have the patience to build everything from scratch. For a suitable framework, I would highly recommend "react" which is a javascript-based framework.
