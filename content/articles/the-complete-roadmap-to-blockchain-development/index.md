...
#### Core developers
Core developers are involved in what is called core development, a cliche right?. In core development, the developer writes the code for a blockchain client. Low-level programming languages are used in writing Blockchain clients the languages include  C, C++, Golang, Rust, etc. In core development, you need to know the operating system of a computer, file system, networking, etc. However, core development is not for the faint of heart. It takes time, practice, and commitment. Blockchain core developers are rare to find and usually prefer to remain anonymous as is the case of Bitcoin's founder under the pseudo name Satoshi Nakamoto.
...
contract HelloWorld {
 ...
 ```
 I hope you can note the similarities to Javascript i.e the functions, the methods, the curly braces, etc. 
