...
Duration is used when you want to specify the time of the audio data you are working with for example if you want to set it for 6 seconds of the entire audio streamline so we set the audio duration to 0.6.
