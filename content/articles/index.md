...
- [Visual studio](https://my.visualstudio.com/Downloads?q=Visual%20Studio%202017) IDE in your machine.
...
As you can see in the above image we choose Empty Activity to build on.
...
After right-clicking on the WebApplication on our right side of the IDE, a popup comes out, we select add and another popup shows up we select webform at the bottom.
...
In the above image you will see two labels, `Username` and `PIN`, two text boxes, and a button `Submit`.
...
In the above image, we right-clicked WebApplication and selected `Add`, we added another web form.

![step-five-a](/engineering-education/cookies-and-sessions-in-asp-dot-net/step-five-a.png)

In the image above we renamed the new web form created.
...
And our username and password are saved.
