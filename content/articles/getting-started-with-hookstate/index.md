...
> Note: The `useState` hook is similar to React's the built-in hook. When accessing hooks simultaneously in a single file, an alias is useful to eliminate ambiguity.
