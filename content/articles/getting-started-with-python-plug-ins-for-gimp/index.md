...
- After an effective establishment of GIMP programming the next thing to introduce is Python on your working framework as indicated by the guidance on the python documentation. You can download the most recent version of python [here](https://www.python.org/downloads/). To affirm that you have effectively introduced python on your OS, open the command line and type 'python --version'. 
