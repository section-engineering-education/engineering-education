...
The code also has `BndBoxes`. This code includes the X and Y values, the height and width of the prediction levels. This code is auto-generated when the class is created.
