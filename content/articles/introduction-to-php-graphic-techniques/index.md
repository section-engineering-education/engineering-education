...
Assuming you are a conventional artist and you want to draw a picture, you will probably require three things: a canvas to draw on, a paintbrush to draw with, and you’ll need ink for the paintbrush to use. That is the same convention we employ while working with PHP graphics and thankfully, the ‘GD’ extension offers us functions that can serve as the canvas, paint brush and ink.
