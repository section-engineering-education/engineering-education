...
2.  Some understanding of linked list data structure and hash tables. 
...
- Visit the [LRU cache](https://leetcode.com/problems/lru-cache/) problem page and go throught the problem statement.
...
#### 2. Get operation
This operation will return the value of the key, if it exists, else, it will return -1.
