...
Azure will dynamically grow your function in accordance to demand if you choose the utilization plan, and you will only be charged for the time it takes your code to execute.
