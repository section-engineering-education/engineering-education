...
To `Dual boot` a machine is having two operating systems installed on the same machine. Take for instance being able to access both Kali Linux and Windows on the same machine. This way, you can choose either to operate on one of them during the booting process.
<!--more-->

### Reasons for installing Kali Linux alongside Windows
- Kali Linux is primarily developed for Security purposes. This limits Kali Linux's support for some integrated development environments. For instance, as a developer, you might not comfortably use Android Studio on Kali Linux compared to Windows.
...
2. Secondary storage eg. Hard disk of not less than 25GB.
...
By now, we have crated a partition.
...
### Software selection
Here you have to choose a desktop environment. A **desktop environment** is the general outlook of the OS after you have logged in. It contains the folders, toolbars and even icons. Take the desktop environment as the general outlook of your Kali Linux.
...
Lastly, click continue without altering the other changes and be patient for the process to be done. This might take a while.

When the installation process is complete, restart your computer and eject the flash disk.

### What happens after rebooting?
After rebooting, Kali Linux will load into `GRUB boot loader`. This is where you're given the option of the OS you want to boot into. For our instance, it's either Kali Linux or Windows. Select Kali Linux to boot into.
