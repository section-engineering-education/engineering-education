...
### Prerequisite
1.  You should know internet protocols such as HTTP, UDP, TCP DNS SMTP, FTP, TCP, POP3, and TELNET as I will only feature an introductory discussion of these protocols within the article.
...
There are two types of network protocols: 
- Stateful protocols. 
- Stateless protocols. 
