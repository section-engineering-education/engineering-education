# Understanding-polymorphism-abstract-classes-using-c-
...
**Polymorphism** is a very helpful concept when it comes to a single abstract idea used in different ways and shapes.
...
```c#
 // return a string of the Employee information
      ...
      // calculating the earnings of an employee
