...
Suppose you want to set a background color, text color, font and center the text of the elements of multiple divs. Let's have a look at the example snippet below:
...
### Conclussion
In this tutorial, we have covered some important `hacks` that every developer needs to know to design a good web app.
