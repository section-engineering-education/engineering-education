...
The hashes ensure the concept of immutability in block data to hold firm.
...
Iterating through the Nonce makes it easy for super-fast computers to mine a block. It has to do with iterating between zero and approximately 4 billion to find the perfect Nonce for the hash to fall below the target.
