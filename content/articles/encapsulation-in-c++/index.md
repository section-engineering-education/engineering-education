...
Encapsulation links a code to the data it distorts. Inheritance allows a class to inherit the attributes and functions of another class. Encapsulation is exemplified by an ATM that binds several denominations of banknotes and all the activities necessary to withdraw money. Inheritance may be seen in the classification of vehicles like cars, bikes, buses, trucks, etc.
