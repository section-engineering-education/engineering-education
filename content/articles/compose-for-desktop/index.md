...
### Getting Started
In this tutorial, we will learn to use Compose for Desktop by building simple user authentication screens. We will therefore learn how to create some basic views like `TextField` and `Button` in a Compose Desktop app. This tutorial will act as a beginner guide to the introduction to Compose for Desktop. 

IntelliJ IDEA has built-in Kotlin plugins and Compose Desktop libraries. 

### Step 1 - Creating Project
To create a Compose Desktop Application, open your IntelliJ IDEA, select `New Project` then select `Kotlin` programming language on the left pane, give your project a name. Remember to select `Compose Desktop Application` in the `Project Template` just below the project location path the click next.

![creating project](/engineering-education/compose-for-desktop/creating-project1.png)

You should check to ensure that the JDK is at least JDK 11, then click on finish to create your project. 
...
Since kotlin is considered a multiplatform language you can build a whole desktop application with Kotlin only. In this tutorial, we have learned how to build auth screens. 
...
### Conclusion
Reading this article will help in getting started with Compose for Desktop apps. To learn more about building desktop apps with this technology you will have to do a lot of practice. If you love creating web applications, with Compose for Web, you can create awesome websites as well.
