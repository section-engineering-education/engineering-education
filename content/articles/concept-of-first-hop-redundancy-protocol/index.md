...
- [Configuring HSRP protocol on a Standard router](#configuring-hsrp-protocol-on-a-standard-router)
- [Conclusion](#conclusion)
- [Activity File](#activity-file)
- [Further reading](#further-reading)

### Goals
At the end of this article, the reader will learn:

- What is First Hop redundancy Protocol (FHRP).

- Various FHRP options that are available.
...
### HSRP features
HSRP uses both active and standby routers to make a failover looks seamless in a network, thus providing redundancy. To determine the active and standby router, HSRP by default uses the numerically highest IPv4 address as it the active router. For better control of the election, HSRP uses the "HSRP priority" option to determine the active router. 
...
### Activity File
The configuration file used for this tutorial can be accessed from this Github repository's [Activity File](https://github.com/raboba2re/config/blob/main/hsrp.pkt)
