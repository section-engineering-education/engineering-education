...
The password generator application you are going to build will have an input button that shows the user the preferred length they want for their password, a minimum of 5 words and a maximum of 20 words. It may include upper and lower case letters as well as symbols. It will also have a generate password button that outputs the random password. Below is a picture of how the application would look like.
