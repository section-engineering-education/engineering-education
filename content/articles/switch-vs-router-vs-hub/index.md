...
- [Addresses used in each devices](#addresses-used-in-each-devices)
...
A Hub is a simple and cheap networking device that works under the physical layer of the OSI model and connects a bunch of computers in a Local Area Network(LAN). (It does lots of wastage of bandwidth). A hub is considered less intelligent because it does not filter data and does not know where the data is to be sent.
...
Read this [documentation](https://afteracademy.com/blog/what-are-the-data-transmission-modes-in-a-network) for more information on the different mode of data transmission.
