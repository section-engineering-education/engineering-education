...
Consider a best-fitting circle that can be slotted into a square with a range of ℝ2 over _[−1, 1]²_.

• the circle radius = 1 and area = π.

• the square has an area of _2² = 4_.

• the ratio between their areas is thus _𝜋/4_.

**Solution**

The following Monte Carlo approach can be used to approximate the value of π:

1. Draw the square over _[−1, 1]²_.
...
Here we take all the points uniformly distributed within the _[−1, 1]²_ unit square
