...
- [Execution of the code to show the flat scrolling menu](#execution-of-the-code-to-show-the-flat-scrolling-menu)
...
* Own customization will consistently work on the code and limit the quantity of documents size.
...
On the snap occasion of these controls, the jQuery function() is called to move the menu things to and fro.
### Execution of the code to show the flat scrolling menu
...
``` 
In a nutshell, our menu is shown horizontally with optimal visibility. Our menu's UI arrow symbols are located on the left and right sides. A hover effect is added to help visualize as we move over the menu. Example of our menu at a glance. ![Demo-picture](https://github.com/Njengab/engineering-education/blob/how-to-create-horizontal-scrolling-menu-using-jquery-and-php/content/articles/how-to-create-horizontal-scrolling-menu-using-jquery-and-php/demo1.png)
...
![Demo-picture](https://github.com/Njengab/engineering-education/blob/how-to-create-horizontal-scrolling-menu-using-jquery-and-php/content/articles/how-to-create-horizontal-scrolling-menu-using-jquery-and-php/demo2.png)
### Conclusion
