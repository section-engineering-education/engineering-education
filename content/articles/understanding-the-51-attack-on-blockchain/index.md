...
<!--more-->
It is prevalent when cryptocurrencies such as [Bitcoin](https://bitcoin.org/en/) are mentioned. However, according to numerous research reports, businesses have not fully adopted the use of cryptocurrencies. Most of these businesses rely on traditional methods in their operations instead of using blockchain technology.
...
- [Can 51% attack reoccur?](#can-51-attack-reoccur)
...
The attackers can stop the confirmation and order of new transactions. The malicious agents can then rewrite parts of a blockchain and reverse the transactions.
...
The blockchain reorganized and caused double spends which lost the users vast amounts of money.  Vertcoin had to switch to a more powerful PoW algorithm to ensure security on its platform. It also had to block powerful mining chips from the network to keep mining more powerful and community-based.
