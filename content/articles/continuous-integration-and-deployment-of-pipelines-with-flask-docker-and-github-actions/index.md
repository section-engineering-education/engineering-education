...
### Conclusion
In this tutorial, we saw the overview of DevOps and built an automated pipeline. Developed a simple Flask application and continuously integrate it with Github actions. 
