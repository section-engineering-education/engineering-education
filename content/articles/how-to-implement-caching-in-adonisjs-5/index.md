...
In this article, we will learn how to implement a caching system on our Forum API developed with Adonis to improve the performance and load time of our API request. We will also integrate the newly created caching package for the new Adonis 5 with optimum caching experience.
...
The package is a Caching Driver implementation similar to Laravel Cache but used with AdonisJS 5, it abstracts away different caching driver implementation and Caching Strategies to expose only the methods that is needed. You can explore more about the package [here](https://github.com/Kaperskyguru/kap-adonis-cache).
