...
1. Try: The try block specifies the code you want to “try” for an exception.
2. Except: With the except, you specify the expected exception that you want your try block to search for and the message you want to be displayed should this be cached
3. Else: The else block contains code that you will want to be executed if the except block fails to catch an exception. Consider this a fall backplane/code
3. Finally: This block of code is executed irrespective of what happens in the blocks above. 
