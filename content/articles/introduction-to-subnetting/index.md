...
**Subnetting** is the process of partioning a network into two or more networks based on utilization. It is a logical process of splitting a single-page network into more strands. Subnetting came into the internet in 1978. 
...
**Internet Protocol address (IP Address):** An IP is a distinctive identifier. It is the foundational protocol that allows the internet to work. It is situated in the internet layer of the TCP/IP model. There are  32- bits numbers.
...
**IP Classes:** Classes are how you can identify network addresses on the internet. The network class an IP address fits into is ascertained by the binary numbers. IP classes are in 5 parts ranging from class A - E. Class A-C are the major used classes.
...
In a Class B network, the initial 16 bits are the network part of the address. While the rest 16 bits are the host parts of the address. In a Class C network, 24 bits are for the network address while the remaining 8 bits are for the host parts of the address. 
...
**Routing:** This is the specialized process of connecting different IP networks. Hosts of different networks cannot communicate with each other until routed. 
        ...
        Image source: (https://computernetworkingnotes.com) (Bonaventure, 2018)
...
References: Bonaventure, O. (2018, September 7). Basic of IP Routing Explained with Example. Retrieved from https://www.computernetworkingnotes.com/ccna-study-guide/basic-of-ip-routing-explained-with-example.html

Robles, G. (2021, April 14). IT: Explained: IP address. Retrieved from https://www.paessler.com/it-explained/ip-address