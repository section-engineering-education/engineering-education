...
A modal is a popup window that appears on top of the main content of a webpage requiring user interaction. It temporarily disables the main content until the user interacts with the modal dialog. Modal dialogs are useful helpful because they give critical warnings to the user as a way of preventing errors.
