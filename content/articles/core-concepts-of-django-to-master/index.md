...
status: publish
published: true
url: /engineering-education/core-concepts-of-django-to-master/
...
---
In today's discussion, I will be introducing you to this great Python backend framework known DJANGO. In the web application development world, there are different server side languages and frameworks of which Django happens to be one. 
<!--more-->
To be clear, Django is just a framework built on top a well known programming language called Python few years back. Join me in this journey of my favorite backend framework to explore more. Yes, you the reader!!
