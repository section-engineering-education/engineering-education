...
images:
  ...
  - url: /engineering-education/how-to-secure-php-resource-with-http-authentication/hero.jpeg
    alt: Apache2 PHP Auth Hero Image
---
...
To enable the `mod_rewrite`, we should run the `a2enmod` command on the Ubuntu server.
...
Above is a complete test that the HTTP authentication and everything else is working correctly.
