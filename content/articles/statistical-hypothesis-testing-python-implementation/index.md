...
#### Chi-square test
[The chi-square test](https://www.mathsisfun.com/data/chi-square-test.html) is used to analyze two categorical variables in a data set. It focuses on the relationship between these two categorical variables. For example, comparing the after-effects of malaria drug A to those of malaria drug B.
...
We use the alternate hypothesis when variable A depends on variable B. 
...
[Test statistic](https://online.stat.psu.edu/statprogram/reviews/statistical-concepts/chi-square-tests) is a characterized feature of significance in the chi-square test. It helps in determining how uncommon the result might be provided that the null hypothesis is assumed to be true.
