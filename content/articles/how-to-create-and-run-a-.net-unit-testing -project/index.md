...
Test suites, methods, test cases, and risk assessments are all carried out using gray box testing.
...
In the event that all tests are successful, then the bar is green; otherwise, it is red.
