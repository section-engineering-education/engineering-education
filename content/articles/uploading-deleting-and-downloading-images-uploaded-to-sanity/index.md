...
- Choose the default dataset configuration by typing y, then hit enter.
- Select project template. Then, choose a clean project with no predefined schemas.
...
![sanity project file structure](/engineering-education/articles-uploading-deleting-and-dowloading-images-uploaded-to-sanity/filestructure.PNG)
...
![sanity.io CMS](/engineering-education/articles-uploading-deleting-and-dowloading-images-uploaded-to-sanity/sanitycms.png)
...
![sanity.io CMS after upload](/engineering-education/articles-uploading-deleting-and-dowloading-images-uploaded-to-sanity/afterinput.png)

At your sanity CMS desk, you should have the photo.

![sanity.io CMS after upload](/engineering-education/articles-uploading-deleting-and-dowloading-images-uploaded-to-sanity/sanitycmsafterupload.png)
...
![sanity.io CMS](/engineering-education/articles-uploading-deleting-and-dowloading-images-uploaded-to-sanity/websiteview.png)
...
For the complete source code, click [here](https://github.com/ben-cdm/Uploading-deleting-and-dowloading-images-uploaded-to-sanity.io/tree/master).
