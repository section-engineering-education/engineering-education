...
An example merge sort is as shown below:
...
An example heap sort is as shown below:
![heap sort-2](engineering-education/searching and sorting techniques/heap sort-1.png)
