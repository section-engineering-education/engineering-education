...
status: publish
published: true
url: /quantum-key-distribution-overview/
title: Quantum Key Distribution - An Overview
...
author: oliver-mulwa
date: 2022-02-14T00:00:00-13:30
topics: [Security]
excerpt_separator: <!--more-->
images:

  - url: /engineering-education/quantum-key-distribution-overview/hero.jpg
    alt: Quantum Key Distribution QKD
---
Quantum key distribution (QKD) is one of the most advanced sub-disciplines of quantum information technology. It aims at coming up with novel and sophisticated methods of securely exchanging cryptographic keys by use of basic quantum mechanical concepts such as entanglement and measurement.
<!--more-->
