...
#### Keys Takeaway 
I will be covering these sub-topics been the most essentials of the Redux itself. Join me to explore more on this journey.
...
What is then the application state?
...
The data to be received from the API will be dispatched as the payload together with the specific action type. Every dispatch methods call the Redux store which triggers the reducers based on the type of action received. 
...
To demonstrate an instance of asynchronous calls in the Redux application, see below logic.
